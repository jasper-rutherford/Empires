/**
 * Game is the biggest of boys, the bestest of the bestest, the biggest and baddest, the ultra magnus, the alpha and
...
public class Game
{
    ...
    /**
     * resets the Game to its default constructor
     */
    private void reset()
    {
        handler = new Handler();
